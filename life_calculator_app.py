...
st.set_page_config(
    page_title="인생 올인원 계산기",
    layout="centered"
)

st.title("🎉 인생 올인원 계산기")
st.caption("인생의 특별한 날 + 표준편차 석차 계산기")
...
""")
    ...
    special_days = [
        ("태어난 지 100일", 100, "아기 첫 공식 기념일"),
        ("태어난 지 1,000일", 1000, "유년기 성장 이정표"),
        ("태어난 지 10,000일", 10000, "인생의 큰 숫자 기념일"),
        ("태어난 지 11,111일", 11111, "숫자 반복의 상징적 날"),
        ("태어난 지 12,345일", 12345, "연속 숫자 기념일"),
        ("태어난 지 20,000일", 20000, "성인 인생의 큰 전환점"),
